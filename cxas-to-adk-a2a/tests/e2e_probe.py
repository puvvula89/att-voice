...
# All environment-specific values come from .env (source it before running).
_PROJECT = os.environ.get("CXAS_PROJECT") or os.environ["GOOGLE_CLOUD_PROJECT"]
_LOCATION = os.environ.get("CXAS_LOCATION", "us")
_APP_ID = os.environ.get("CXAS_APP_ID", "att-ivr-steering-a2a")
APP = f"projects/{_PROJECT}/locations/{_LOCATION}/apps/{_APP_ID}"
